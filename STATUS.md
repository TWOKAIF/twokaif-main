...
## 🆕 2026-06-28 — единый юр-кит + страница /oferta (ветка `seo-разгон-202606`, НЕ задеплоено)
SEO-разгон + единая юр-обвязка для всех сайтов ТУКАЙФ. Локально, ждёт деплоя.
